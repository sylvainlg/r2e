 ...
 */
final class Version20190912202934 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , feed_id INTEGER NOT NULL, datetime DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , type VARCHAR(255) DEFAULT NULL COLLATE BINARY, trace CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_1BD0E1FA51A5BC03 FOREIGN KEY (feed_id) REFERENCES rss_feed (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
