 ...
 */
final class Version20190928095220 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , feed_id INTEGER NOT NULL, type VARCHAR(255) DEFAULT NULL COLLATE BINARY, trace CLOB DEFAULT NULL COLLATE BINARY, datetime DATETIME NOT NULL, message VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_1BD0E1FA51A5BC03 FOREIGN KEY (feed_id) REFERENCES rss_feed (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
